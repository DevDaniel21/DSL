    ...
    return (
        <div className={styles.container}>
            ...
            <p className={styles.terms}>
                Ao continuar, você concorda com os <a href='#'>Termos de uso</a> e a <a href='#'>Política de Privacidade</a> da DSX e seus parceiros, e em receber comunicações da DSX.
            </p>
        </div>
    )
}